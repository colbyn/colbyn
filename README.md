...
This is the value I bring to the table, and is why my research style is very ‘evaluative’ and in an ‘exploratory’ manner. If your looking for an answer that can’t be known upfront, then I will come in and *compute* the problem to completion.
