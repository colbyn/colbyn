...
4. I also once made an indentation based shell scripting language with some much needed improvements that all unix systems need... Although this is probably the least loved of all my projects for some reason. But this is not cool?
   ```
...
- [Why does the world need software researchers?](https://open.substack.com/pub/colbynwadman/p/why-does-the-world-need-software?r=28sf0r&utm_campaign=post&utm_medium=web&showWelcomeOnShare=false): Ideas are cheap; nowadays methodology matters more than ever. For all the low hanging fruit is gone; the simplest opportunities have been taken.
