...
Ultimately if no solution is found then those aspects of the private sector that depend on university trained talent must be allowed to fail so someone else can figure it out. 
